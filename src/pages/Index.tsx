  ...
  return (
    <>
      <Helmet>
        ...
        <title>Friseursalon Berlin | Salon Stage</title>
        <meta
          name="description"
          content="Besuche unseren Premium Friseursalon Salon Stage in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
          content="Friseursalon, Herrenfriseur, Haarschnitt, Bartpflege, Rasur, Berlin"
        />
        <link rel="canonical" href="https://gentlemanscut.de" />

        {/* Open Graph */}
        <meta property="og:title" content="Salon Stage | Premium Friseursalon Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Salon Stage | Premium Friseursalon Berlin" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "sameAs": [
              "https://www.facebook.com/salonstage",
              "https://www.instagram.com/salonstage"
            ]
          })}
        </script>
      </Helmet>
